  ...
  return (
    <input
      ...
      className={merge(
        ...
        "text-primary-500 checked:bg-primary-500 hover:text-green-600 focus:ring-primary-300 dark:checked:bg-primary-500 dark:hover:checked:bg-green-600 dark:focus:ring-primary-300  cursor-pointer transition-all ",
        props.className,
      )}
    />
  )
