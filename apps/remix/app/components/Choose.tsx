      ...
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="flex flex-col items-center justify-center lg:w-fit">
            ...
            Откройте для себя уникальные условия аренды техники в ОАО "Ружаны-Агро". Мы предлагаем лучшие варианты аренды сельскохозяйственной техники, которые обеспечат вам отличное соотношение цены и качества. Наша техника надёжна, высокоэффективна и доступна по оптимальным условиям, что позволит вам сэкономить и повысить производительность. Мы стремимся, чтобы каждый клиент получил максимум выгоды от сотрудничества с нами.
            </p>
            <button
